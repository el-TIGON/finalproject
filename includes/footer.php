<div class="footer-main-w3_agile">
			...
			<div class="container">
				<div class="footer-bottom">
					<div class="col-md-4 col-sm-6 col-xs-6 footer-grid1 address">
						...
						<ul>
							<li>
								...
								<p>150 street Hargiesa, Somaliland.</p>
							</li>
							<li>
								<span class="fa fa-envelope-o" aria-hidden="true"></span>
								<a href="mailto:info@example.com">info@homeservice.com</a>
							</li>
							<li>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 footer-grid1 res">
						...
						<ul>
							<li>
								<a href="../services.php">appliance repair</a>
							</li>
							<li>
								<a href="../services.php">home improvement</a>
							</li>
							<li>
								<a href="../services.php">home maintenance</a>
							</li>
						</ul>
					</div>
			</div>
	...
	<div class="cpy-footer">
		...
		<div class="cpy-text">
			<p>© 2022 HOME Service. All rights reserved </p>
		</div>
